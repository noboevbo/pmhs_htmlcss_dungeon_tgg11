...
let tips = [
    {
        level: 1,
        title: "Typselektor",
        content: `Typselektoren geben Styles für bestimmte HTML-Tags an, will man z.B. für alle ListItem (li) Elemente einen Style angeben schreibt man als Selektor einfach den HTML-Elementnamen <xmp>li { ... }</xmp> verwenden.`,
        weblinks: ["https://wiki.selfhtml.org/wiki/CSS/Selektoren/Typselektor"],
        contentIsHTML: true,
    },
    {
        level: 2,
        ...
        content:
            "Bei der Kombination von Selektoren kommt es darauf an, wie die Elemente zusammenhängen. In dieser Aufgabe enthält jedes li-Element ein a-Element, es liegt also eine Kind-Beziehung vor (a ist Kind von li). Dafür kann der Kindselektor verwendet werden. Im Beispiel wäre das <xmp>li > a { ... }</xmp>",
        weblinks: [
  ...
  `,
        weblinks: [
            "https://wiki.selfhtml.org/wiki/CSS/Tutorials/Hintergrund/Gestaltung_mit_CSS",
            "https://wiki.selfhtml.org/wiki/CSS/Selektoren/hover",

...
let tips = [
    {
        ...
        weblinks: ["https://www.w3schools.com/html/html_forms.asp"],
    },
    {
        level: 2,
        title: "Art des Eingabefelds angeben.",
        content: `Die Art des Eingabefelds wird über das Attribut type angegeben. Ein Beispiel wäre: <xmp><input type="password" [...]></xmp>
  Hier wurde der Type auf <em>password</em> gesetzt, das Eingabefeld wird vom Browser automatisch als Passwortfeld behandelt und die eingegebenen Zeichen durch Punkte oder Sternchen ersetzt. Es gibt weitere Typen wie <em>number</em> (für nummerische Eingaben), radio (für eine Auswahl aus mehreren Möglichkeiten), <em>checkbox</em> (für Mehrfachauswahlen) oder <em>submit</em> für den Bestätigungsbutton. Weitere Infos findest du auf der verlinkten Website.`,
        weblinks: ["https://www.w3schools.com/html/html_paragraphs.asp"],
        contentIsHTML: true,
    },
    {
        level: 3,
...
let validationFuncs = [
    ...
    function () {
        return elementIsDirectChildOf("vorname", "formular1");
    },
    function () {
    ...
    function () {
        return elementIsDirectChildOf("nachname", "formular1");
    },
    function () {
    ...
    function () {
        return elementIsDirectChildOf("passwort", "formular1");
    },
    function () {
    ...
    function () {
        return elementIsDirectChildOf("newsletter", "formular1");
    },
    function () {
    ...
    function () {
        return elementIsDirectChildOf("registerbtn", "formular1");
    },
];
